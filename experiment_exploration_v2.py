...
if __name__ == '__main__':
	...
	#for path connections add to the form : [input connection matrix, reservoir connection matrix]
	parameters = dict(
		path_connections = [['inp_Cr_2048_I_50_R_3.txt','Corr_Cr_2048_I_50_R_3.txt'], ['inp_Cr_2048_I_50_R_6.txt', 'Corr_Cr_2048_I_50_R_6.txt']] 
		, memoryless=[True]
		,win=['1.0']
